...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 right-0 h-full z-50 w-16 glass-panel border-l border-[var(--glass-border)]
      ...
      >
        {/* Logo */}
        <div className="w-9 h-9 rounded-[var(--radius-default)] bg-[var(--color-accent)] flex items-center justify-center shadow-[var(--shadow-glow-accent)] mb-3">
          ...
          {PRIMARY_ITEMS.map(item => {
            ...
            return (
              <button
                ...
                className={`
                  relative group w-10 h-10 rounded-[var(--radius-default)] flex items-center justify-center
              ...
              >
                ...
                {/* Tooltip */}
                <span className="absolute left-full mr-3 px-2 py-1 rounded-[var(--radius-sm)] bg-[var(--color-surface-dark)] text-white text-[11px] font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity z-50 hidden lg:block">
                  {item.label}
                </span>
              </button>
            )
          ...
          <AnimatePresence>
            {moreOpen && (
              <motion.div
                ...
                className="absolute bottom-0 left-full mr-2 glass-panel rounded-[var(--radius-xl)] p-3 w-[280px] z-[60] shadow-lg"
              >
